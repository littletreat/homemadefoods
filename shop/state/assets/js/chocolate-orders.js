const WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbyCT3S1Ye3NrSv-4uuPB5HlF-ySikjz2sTLYz_D1D1KAHQCcskcSS0M6XKSNBWcqi3o/exec';
let allOrders = [];
...
async function loadOrders() {
    try {
        ...
        console.log('Number of orders:', data.count || data.orders?.length);
